...
<body><pre><?php
  ...
  try {
    ...
    // Requête d'insertion
    $requete = "INSERT INTO `podcasts` (`podcast_name`, `podcast_description`, `podcast_url`, `podcast_podcast_id`)
    ...
    $prepare->execute(array(
      ...
      ":podcast_url" => "https://cdn.radiofrance.fr/s3/cruiser-production/2020/11/942a9fa8-8e02-43c7-ad06-3568d8c87099/l_affaire_benalla_podcasts_1_l_inconnu_de_la_contrescarpe.2020c41407e0005.ite_00111257_rsce.mp3",
      ":podcast_id" => 1,
    ));
